...
// Wrapped in an IIFE so `parseCardText`/`FIELDS` don't leak as globals when
// loaded via a plain <script> tag alongside other scripts.
(function (root) {
...
// Export for Node (CLI) and attach to the global for the browser app.
if (typeof module !== "undefined" && module.exports) {
  module.exports = { parseCardText, FIELDS };
} else {
  root.CardParser = { parseCardText, FIELDS };
}
